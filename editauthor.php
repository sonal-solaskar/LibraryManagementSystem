...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_POST['authorid'])){
        ...
        $sql = "UPDATE author SET fullName = '$fullName', aemail = '$aemail', mobileNumber = '$mobileNumber' WHERE id = '$authorid'";
                    ...
                    <div class="img-overlay">
                        <div class="content">
                            ...
                            <h1>Edit Author</h1><br>
                                ...
                                <input type="text" id="fullName" name="fullName" value="<?=$author['fullName'];?>" required><br><br>
                                
                                <label for="aemail">Email:</label>
                                <input type="email" id="aemail" name="aemail" value="<?=$author['aemail'];?>" required><br><br>
                                
                                <label for="mobileNumber">Mobile Number:</label>
                                <input type="text" id="mobileNumber" name="mobileNumber" value="<?=$author['mobileNumber'];?>" required><br><br>

                            <input type="submit" id="btn" class="primary-btn" value="Edit Author">      
                            </form>
                            <?php
                                }
                                else{
