                    ...
                    <div class="img-overlay">
                        <div class="content">
                            ...
                            <h1>Delete Member</h1><br>
                                ...
                                <input type="text" id="fullName" name="fullName" value="<?=$member['fullName'];?>" readonly required><br><br>
                                
                                <label for="memail">Email:</label>
                                <input type="email" id="memail" name="memail" value="<?=$member['memail'];?>" readonly required><br><br>
                                
                                <label for="mobileNumber">Mobile Number:</label>
                                <input type="text" id="mobileNumber" name="mobileNumber" value="<?=$member['mobileNumber'];?>" readonly required><br><br>

                            <input type="submit" id="btn" class="primary-btn" value="Delete Member">      
                            </form>
                            <?php
                                }
                                else{
