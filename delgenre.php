                ...
                <div class="overlay swiper-slide">
                    ...
                    <div class="img-overlay">
                        <div class="content">
                            ...
                            <h1>Delete Genre</h1><br>
                                <label for="genreid">Id:</label>
                                <input type="number" id="genreid" name="genreid" value="<?=$genre['id'];?>" readonly required><br><br>

                                <label for="genre">Genre:</label>
                                <input type="text" id="genre" name="genre" value="<?=$genre['genre'];?>" readonly required><br><br>

                            <input type="submit" id="btn" class="primary-btn" value="Delete Genre">      
                            </form>
                            <?php
                                }
                                else{
