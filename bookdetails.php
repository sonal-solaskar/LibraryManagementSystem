            ...
            <div class="slide-content swiper-wrapper">
                <div class="overlay swiper-slide">
                    ...
                    <div class="img-overlay">
                        ...
                        <?php if($num_rows == 0): ?>
                                <h2>No Books yet!</h2>
                                <br><input type="button" id="edit" onclick="document.location='book.php'" class="primary-btn" value="Add Book">
                            <?php else: ?>
                                <table border='1'>
                                    <tr>
                                        <th>Book Id</th>
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        $id = $row['id'];
                                        echo "<td><a href='editbook.php?id=$id' class='btn'>Edit</a></td>";
                                        echo "<td><a href='delbook.php?id=$id' class='btn'>Delete</a></td>";
                                        echo "</tr>";
                                    }
                                    ?>
                                </table>
