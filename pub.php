...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $mobileNumber = mysqli_real_escape_string($conn, $_POST["mobileNumber"]);
        ...
        $sql = "INSERT INTO publisher (fullName, pemail, mobileNumber)
            VALUES ('$fullName', '$pemail', '$mobileNumber')";
                ...
                <div class="overlay swiper-slide">
                    ...
                    <div class="img-overlay">
                        <div class="content">
                            ...
                            <input type="submit" id="btn" class="primary-btn" value="Add Publisher">
