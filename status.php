                ...
                <div class="overlay swiper-slide">
                    ...
                    <div class="img-overlay">
                        ...
                        <?php
                            ...
                            ?>
                            <br>
                        <input type="button" id="edit" onclick="document.location='issuebookdetails.php'" class="primary-btn" value="Issue Book">
                        <input type="button" id="edit" onclick="document.location='returnbook.php'" class="primary-btn" value="Return Book">
                        </div>
                    </div>
                </div>
            </div>
