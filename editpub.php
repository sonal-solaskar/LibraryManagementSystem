...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_POST['pubid'])){
        ...
        $sql = "UPDATE publisher SET fullName = '$fullName', pemail = '$pemail', mobileNumber = '$mobileNumber' WHERE id = '$pubid'";
                ...
                <div class="overlay swiper-slide">
                    ...
                    <div class="img-overlay">
                        <div class="content">
                            ...
                            <h1>Edit Publisher</h1><br>
                                <label for="pubid">Id:</label>
                                <input type="number" id="pubid" name="pubid" value="<?=$pub['id'];?>" readonly required><br><br>

                                <label for="fullName">Name:</label>
                                <input type="text" id="fullName" name="fullName" value="<?=$pub['fullName'];?>" required><br><br>
                                
                                <label for="pemail">Email:</label>
                                <input type="email" id="pemail" name="pemail" value="<?=$pub['pemail'];?>" required><br><br>
                                
                                <label for="mobileNumber">Mobile Number:</label>
                                <input type="text" id="mobileNumber" name="mobileNumber" value="<?=$pub['mobileNumber'];?>" required><br><br>

                            <input type="submit" id="btn" class="primary-btn" value="Edit Publisher">      
                            </form>
                            <?php
                                }
                                else{
