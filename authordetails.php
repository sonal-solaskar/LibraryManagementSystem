                ...
                <div class="overlay swiper-slide">
                    ...
                    <div class="img-overlay">
                        ...
                        <?php if($num_rows == 0): ?>
                                ...
                                <br><input type="button" id="edit" onclick="document.location='author.php'" class="primary-btn" value="Add Author">
                            <?php else: ?>
                                <table border='1'>
                                    <tr>
                                        <th>Author Id</th>
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        $authorid = $row['id'];
                                        echo "<td><a href='editauthor.php?id=$authorid' class='btn'>Edit</a></td>";
                                        echo "<td><a href='delauthor.php?id=$authorid' class='btn'>Delete</a></td>";
                                        echo "</tr>";
                                    }
                                    ?>
                                </table>
                            <?php endif; ?>
                            <br><br><input type="button" id="btn" class="primary-btn" value="Add Author" onclick="document.location='author.php'">
                        </div>
                    </div>
                </div>
            </div>
